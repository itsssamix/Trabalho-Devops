...
def reserve():
    ...
    if product.quantity >= data['quantity']:
        ...
        db.session.commit()
        publish_event('InventoryReserved', {'product_id': product.id, 'quantity': data['quantity']})
...
def release():
    ...
    product.quantity += data['quantity']
    db.session.commit()
    publish_event('InventoryReleased', {'product_id': product.id, 'quantity': data['quantity']})
